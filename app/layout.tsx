...
export const metadata: Metadata = {
  ...
  description:
    "15+ বছরের অভিজ্ঞতাসম্পন্ন জ্যোতিষাচার্য সুমন চক্রবর্তীর কাছ থেকে জন্মকুণ্ডলী বিশ্লেষণ, কুষ্ঠি মিলন, বাস্তু, রত্ন পরামর্শ ও গ্রহ শান্তির বিশ্বস্ত সমাধান নিন।",
  keywords: [
    "জ্যোতিষী",
    "কুণ্ডলী",
    "বাংলা জ্যোতিষ",
  ...
  openGraph: {
    title: "জ্যোতিষাচার্য সুমন চক্রবর্তী | বৈদিক জ্যোতিষ ও কুণ্ডলী পরামর্শ",
    description:
      "গ্রহ-নক্ষত্রের ভাষা পড়ে জীবনের পথ দেখানো — 15+ বছরের অভিজ্ঞতাসম্পন্ন জ্যোতিষাচার্যের কাছে বিশ্বস্ত পরামর্শ নিন।",
    locale: "bn_IN",
    type: "website",
  },
