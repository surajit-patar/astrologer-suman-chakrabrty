...
const credentials = [
  ...
  "15+ বছরের অভিজ্ঞতা, ৪০,০০০+ কুণ্ডলী বিশ্লেষণ",
  "M.A সংস্কৃত, B.ED",
];
        ...
        <div>
          ...
          <ScrollReveal delay={0.1}>
            <p className="mt-6 leading-relaxed text-moon/80">
              ...
              সুমন চক্রবর্তী ছোট থেকেই K.P. Nadi Numerology জ্যোতিষ ও সংস্কৃত শাস্ত্রে
              দীক্ষিত। গত 15+ বছর ধরে তিনি হাজারো মানুষের জীবনের জটিল সিদ্ধান্তে
